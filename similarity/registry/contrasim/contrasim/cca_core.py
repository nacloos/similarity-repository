...
def compute_cca(acts1, acts2):
    acts1 = acts1.transpose(1, 0)
    acts2 = acts2.transpose(1, 0)
    results = get_cca_similarity(acts1, acts2)
...
if __name__ == '__main__':
    # Basic CCA of two vectors:
    a = np.random.randn(50, 2000)
    b = np.random.randn(100, 2000)
    sim = compute_svcca(a, b)
    pass