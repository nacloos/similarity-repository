...
def kcca(
    ...
    # r, Vs = eigh(LH, RH, eigvals=(maxCC - numCC, maxCC - 1))  # deprecated
    # TODO: raise error because non hermitian matrix
    # r, Vs = eigh(RH, LH, subset_by_index=(maxCC - numCC, maxCC - 1))
    import scipy
    r, Vs = scipy.linalg.eig(RH, LH)
